...
fun DependencyHandler.mybatis(module: String, version: String) = "org.mybatis:${module}:${version}"

fun DependencyHandler.xerial(module: String, version: String) = "org.xerial:${module}:${version}"

fun DependencyHandler.junit(module: String, version: String) = "org.junit.jupiter:junit-jupiter-${module}:${version}"

fun DependencyHandler.cssxsh(module: String, version: String) = "xyz.cssxsh.${module.substringBeforeLast('-')}:${module}:${version}"