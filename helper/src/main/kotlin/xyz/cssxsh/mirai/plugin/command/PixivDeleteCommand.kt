...
object PixivDeleteCommand : CompositeCommand(
    ...
    @SubCommand
    @Description("删除指定作品")
    suspend fun ConsoleCommandSender.artwork(pid: Long) {
    ...
    suspend fun ConsoleCommandSender.user(uid: Long) {
    ...
    suspend fun ConsoleCommandSender.bookmarks(bookmarks: Long) {
