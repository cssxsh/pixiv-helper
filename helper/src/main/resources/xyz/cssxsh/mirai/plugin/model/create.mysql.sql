...
(
    ...
    `name`    NVARCHAR(15) NOT NULL COLLATE 'utf8mb4_unicode_ci',
...
(
    `pid`             INTEGER      NOT NULL,
    `name`            NVARCHAR(30) NOT NULL COLLATE 'utf8mb4_bin',
    `translated_name` NVARCHAR(64) COLLATE 'utf8mb4_bin',
...
(
    ...
    `group`     INTEGER,
    `pid`       INTEGER,
    `tag`       NVARCHAR(30) NOT NULL COLLATE 'utf8mb4_unicode_ci',
    `timestamp` INTEGER      NOT NULL,
    PRIMARY KEY (`sender`, `timestamp`)
);
CREATE TABLE IF NOT EXISTS statistic_search
(
    `md5`        NCHAR(32)     NOT NULL COLLATE 'ascii_general_ci',
